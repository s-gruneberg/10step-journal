...
export const defaultQuestions = [
    ...
    "Was I thinking of what I could do for others and what I could pack into the stream of life?"
]
...
export function getCheckmarkStates(): Record<string, boolean> {
    ...
    try {
        ...
        // Only return checkmarks that are explicitly true
        return Object.fromEntries(
            Object.entries(parsed).filter(([_, value]) => value === true)
        );
    } catch {
        return {};
    }
